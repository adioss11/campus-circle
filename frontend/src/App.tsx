      ...
      <main className={isAuth ? "stage is-auth" : "stage"}>
        <section className="brand">
          ...
          <p className="description">
            Campus events happen every day, but they are easy to miss and often
            feel empty. See who is going — or find someone to go with — so you
            are not the first to walk in.
          </p>
